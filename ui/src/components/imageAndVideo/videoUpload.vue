<template>
  <div class="upload-section">
    ...
    <div class="content-wrapper">
      <div class="upload-wrapper">
        ...
        >
          ...
          <div slot="tip" class="el-upload__tip">
            <el-link type="warning">请上传mp4/avi文件</el-link>
          </div>
        </el-upload>
      </div>
      <div v-if="results.length > 0" class="table-wrapper">
        ...
        <el-table :data="paginatedResults" style="width: 100%">
          ...
          >
            <template slot-scope="scope">
              <el-button size="small" @click="viewVideo(scope.row.videoUrl)">查看视频</el-button>
              <el-button size="small" @click="downloadVideo(scope.row.downloadVideoUrl)">下载视频</el-button>
    ...
    <el-dialog :visible.sync="dialogVisible" @close="dialogVisible = false">
      <video :src="currentVideoUrl" controls class="video-dialog" />
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    downloadVideo(downloadVideoUrl) {
      const fileName = downloadVideoUrl.split('/').pop()
...
.background-container1::before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('https://images.ctfassets.net/kftzwdyauwt9/1XeXlBlWdUBSPFcVPsOmOD/dc8123f1031a0f9fe1b816790ee510a9/Structured_Outputs_Cover.png?w=3840&q=90&fm=webp');
